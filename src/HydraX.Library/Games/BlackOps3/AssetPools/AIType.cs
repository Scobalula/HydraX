    ...
    public partial class BlackOps3
    {
        ...
        private class AIType : IAssetPool
        {
            ...
            public HydraStatus Export(GameAsset asset, HydraInstance instance)
            {
                ...
                var result = GameDataTable.ConvertStructToGDTAsset(buffer, AITypeOffsets, instance, HandleAITypeSettings);
            ...
            /// </summary>
            private static object HandleAITypeSettings(byte[] assetBuffer, int offset, int type, HydraInstance instance)
            {
                switch (type)
                {
                    case 0x33:
