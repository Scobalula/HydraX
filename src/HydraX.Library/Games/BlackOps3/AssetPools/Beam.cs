    ...
    public partial class BlackOps3
    {
        ...
        private class Beam : IAssetPool
        {
            ...
            public HydraStatus Export(GameAsset asset, HydraInstance instance)
            {
                ...
                var result = GameDataTable.ConvertStructToGDTAsset(buffer, BeamOffsets, instance, HandleBeamSettings);
            ...
            /// </summary>
            private static object HandleBeamSettings(byte[] assetBuffer, int offset, int type, HydraInstance instance)
            {
                switch (type)
                {
                    case 0x33:
