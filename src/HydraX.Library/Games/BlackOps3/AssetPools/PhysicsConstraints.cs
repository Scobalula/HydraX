    ...
    public partial class BlackOps3
    {
        ...
        private class PhysicsConstraints : IAssetPool
        {
            ...
            public HydraStatus Export(GameAsset asset, HydraInstance instance)
            {
                ...
                var result = GameDataTable.ConvertStructToGDTAsset(buffer, PhysicsConstraintsOffsets, instance, HandlePhysicsConstraintsSettings);
            ...
            /// </summary>
            private static object HandlePhysicsConstraintsSettings(byte[] assetBuffer, int offset, int type, HydraInstance instance)
            {
                switch (type)
                {
                    case 0x33:
