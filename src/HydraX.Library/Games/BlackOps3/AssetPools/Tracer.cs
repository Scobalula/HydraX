    ...
    public partial class BlackOps3
    {
        ...
        private class Tracer : IAssetPool
        {
            ...
            public HydraStatus Export(GameAsset asset, HydraInstance instance)
            {
                ...
                var result = GameDataTable.ConvertStructToGDTAsset(buffer, TracerOffsets, instance, HandleLaserSettings);
            ...
            /// </summary>
            private static object HandleLaserSettings(byte[] assetBuffer, int offset, int type, HydraInstance instance)
            {
                switch (type)
                {
                    case 0x33:
