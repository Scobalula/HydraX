    ...
    public partial class BlackOps3
    {
        ...
        private class Character : IAssetPool
        {
            ...
            public HydraStatus Export(GameAsset asset, HydraInstance instance)
            {
                ...
                var result = GameDataTable.ConvertStructToGDTAsset(buffer, CharacterOffsets, instance, HandleCharacterSettings);

                result.Type = "character";

                // Add to GDT
                instance.GDTs["AI"][asset.Name] = result;
            ...
            /// </summary>
            private static object HandleCharacterSettings(byte[] assetBuffer, int offset, int type, HydraInstance instance)
            {
                switch (type)
                {
                    case 0x33:
